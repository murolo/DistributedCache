...
#define REDIS_DB_LESS_MEMORY    4096
...
typedef struct redisConfig {
    ...
    int zset_max_size;
    int set_max_size;
    int max_evict_each_time;
    int timed_task_start;
    int timed_task_end;
    int timed_task_clean_times;
} redisConfig;
...
struct redisServer {
    ...
    /* area resource locks */
    pthread_mutex_t *area_res_mutexs;
...
int in_time_range(int start, int end);
