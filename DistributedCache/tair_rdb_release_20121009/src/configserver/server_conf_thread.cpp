  ...
  namespace config_server {
                                                  ...
                                                  response_query_info * resp)
    {
      ...
      case request_query_info::Q_DATA_SEVER_INFO:
        {
          log_debug("===========> query_data_server_info");
          server_info_rw_locker.rdlock();
