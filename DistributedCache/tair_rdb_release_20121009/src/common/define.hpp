...
#define RDB_MAX_EVICT_EACH_TIME         "max_evict_each_time"

#define RDB_LIST                        "list"
#define RDB_HASH                        "hash"
#define RDB_ZSET                        "zset"
#define RDB_SET                         "set"

#define RDB_TIMED_TASK_TIME_RANGE       "timed_task_time_range"
#define RDB_TIMED_TASK_CLEAN_TIMES      "timed_task_clean_times"
#define RDB_AREA_DETAIL                 "area_detail"
#define RDB_STRUCT_SIZE                 "struct_size"
#define RDB_EVICT_KEYS_EACH_EXCEED      "evict_keys_each_exceed"
...
// USE FOR CLIENT
#define TAIR_CLIENT_NOT_CARE_VERSION    0
#define TAIR_CLIENT_NOT_CARE_EXPIRE     -1
#define TAIR_CLIENT_CANCEL_EXPIRE       0
...
enum {
   ...
   TAIR_RETURN_CONNECT_ERROR_OR_TIMEOUT = -1,
...
typedef enum {
  ...
  // for no  not handled in switch warning
