...
namespace tair {
   ...
   public:
      ...
      int process (request_lset * request, bool & send_return);
      ...
      /* duplicate */
      int process(request_ltrim_dup* request, bool& send_return) ;
      int process (request_lrem_dup * request, bool & send_return) ;
      int process (request_lset_dup * request, bool & send_return) ;
      int process(request_hmset_dup* request, bool& send_return) ;
      int process (request_hset_dup * request, bool & send_return) ;
      int process (request_hsetnx_dup * request, bool & send_return) ;
      int process (request_hdel_dup * request, bool & send_return) ;
      int process (request_spop_dup * request, bool & send_return) ;
      int process (request_srem_dup * request, bool &send_return);
      int process (request_srem_multi_dup * request, bool &send_return);
      int process (request_sadd_multi_dup * request, bool & send_return) ;
      int process (request_zadd_dup * request, bool & send_return);
      int process (request_zrem_dup * request, bool &send_return);
      int process (request_zremrangebyrank_dup * request, bool &send_return);
      int process (request_zremrangebyscore_dup * request, bool &send_return);
      int process (request_lrpush_dup * request, bool & send_return);
      int process (request_lrpush_limit_dup * request, bool & send_return);
      int process (request_lrpop_dup * request, bool & send_return);
      int process(request_putnx_dup *request, bool &send_return);
      int process(request_put_dup *request, bool &send_return) ;
      int process(request_remove_dup* request, bool& send) ;
      int process (request_sadd_dup * request, bool & send_return);
