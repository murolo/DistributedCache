...
namespace tair {
   ...
   public:
      ...
      typedef boost::shared_ptr<base_packet> request_duplicate_packet;
   ...
   public:
      ...
      int duplicate_data(const vector<uint64_t>& des_server_ids, base_packet *request, int version);
      ...
      bool is_bucket_available(uint32_t bucket_number);
