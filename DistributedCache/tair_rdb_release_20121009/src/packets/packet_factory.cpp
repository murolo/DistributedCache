   ...
   tbnet::Packet *tair_packet_factory::_createPacket(int pcode)
   {
      ...
      switch (pcode) {
         ...
         case TAIR_REQ_LSET_PACKET:
            packet = new request_lset();
            break;
         case TAIR_RESP_LSET_PACKET:
            packet = new response_lset();
            break;
         ...
         case TAIR_RESP_ZREVRANGE_PACKET:
            ...
            break;
         case TAIR_RESP_ZREVRANGEWITHSCORE_PACKET:
            packet = new response_zrevrangewithscore();
            break;
        ...
        // agile admin
         case 3000:
            packet = new agile::admin_packet_t(3000);
            break;

         //duplicate
         case TAIR_REQ_PUT_DUPLICATE_PACKET:
            packet = new request_put_dup();
            break;
         case TAIR_REQ_PUTNX_DUPLICATE_PACKET:
            packet = new request_putnx_dup();
            break;
         case TAIR_REQ_REMOVE_DUPLICATE_PACKET:
            packet = new request_remove_dup();
            break;
         case TAIR_REQ_LPUSH_DUPLICATE_PACKET:
            packet = new request_lrpush_dup(pcode);
            break;
