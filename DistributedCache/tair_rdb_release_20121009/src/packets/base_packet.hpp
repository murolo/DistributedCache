...
namespace tair
{
  ...
  enum
  {
    ...
    TAIR_REQ_OP_CMD_PACKET = 16,
    TAIR_RESP_OP_CMD_PACKET = 17,
    ...
    TAIR_REQ_LSET_PACKET = 2166,
    TAIR_RESP_LSET_PACKET = 2266,

    //duplicate
    TAIR_REQ_PUT_DUPLICATE_PACKET = 4000,
    TAIR_REQ_PUTNX_DUPLICATE_PACKET = 4001,
    TAIR_REQ_REMOVE_DUPLICATE_PACKET ,
    TAIR_REQ_LTRIM_DUPLICATE_PACKET, 
    TAIR_REQ_LREM_DUPLICATE_PACKET,
    TAIR_REQ_LSET_DUPLICATE_PACKET,
    TAIR_REQ_HMSET_DUPLICATE_PACKET,
    TAIR_REQ_HSET_DUPLICATE_PACKET,
    TAIR_REQ_HSETNX_DUPLICATE_PACKET,
    TAIR_REQ_HDEL_DUPLICATE_PACKET,
    TAIR_REQ_SPOP_DUPLICATE_PACKET,
    TAIR_REQ_SREM_DUPLICATE_PACKET,
    TAIR_REQ_SREM_MULTI_DUPLICATE_PACKET,
    TAIR_REQ_SADD_DUPLICATE_PACKET,
    TAIR_REQ_SADD_MULTI_DUPLICATE_PACKET,
    TAIR_REQ_ZADD_DUPLICATE_PACKET,
    TAIR_REQ_ZREM_DUPLICATE_PACKET,
    TAIR_REQ_ZREMRANGEBYRANK_DUPLICATE_PACKET,
    TAIR_REQ_ZREMRANGEBYSCORE_DUPLICATE_PACKET, 
    TAIR_REQ_LPUSH_DUPLICATE_PACKET,
    TAIR_REQ_LPUSHX_DUPLICATE_PACKET,
    TAIR_REQ_RPUSH_DUPLICATE_PACKET,
    TAIR_REQ_RPUSHX_DUPLICATE_PACKET,
    TAIR_REQ_LPUSH_LIMIT_DUPLICATE_PACKET, 
    TAIR_REQ_RPUSH_LIMIT_DUPLICATE_PACKET, 
    TAIR_REQ_LPUSHX_LIMIT_DUPLICATE_PACKET, 
    TAIR_REQ_RPUSHX_LIMIT_DUPLICATE_PACKET, 
    TAIR_REQ_LPOP_DUPLICATE_PACKET, 
    TAIR_REQ_RPOP_DUPLICATE_PACKET, 
  };
...
#define PUT_PDATAENTRY_TO_BUFFER(output, key) do {                  \
...
#define GETKEY_FROM_PDATAENTRY(input,key) do {                  \
...
#define HEADER_VERIFY do {                                  \
  ...
  public:
    ...
    virtual uint32_t get_packet_id() {
        return 0;
    }

    virtual void set_packet_id(uint32_t id) {
        return;
    }
